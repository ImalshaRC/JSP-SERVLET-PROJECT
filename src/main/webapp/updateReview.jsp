...
<div class="container">
    ...
    <div class="row">
        ...
        <form method="post" action="UpdateReview">
            ...
            <center><h2><b>update review</b></h2></center><br/>

			Review ID : <input type="text" name ="id1" value="<%= id%>" readonly/><br/><br/>
            rate score : <input type="text" name ="rate1" value="<%= rating%>"/><br/><br/>
	        Feedback : <input type="text" name ="fdb1" value="<%= feedback%>"/><br/><br/>

    <input type="submit" name="add" class="login3" value="update review"/>
    <a href="javascript:history.back()">
    <input type="button" name="back" class="login3" value="back to Reviews"/>
    </a>
